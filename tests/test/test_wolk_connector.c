...
void test_wolk_connector_wolk_init_simple(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(W_FALSE, wolk_init(&wolk, NULL, NULL, NULL, ACTUATOR_STATE_READY, NULL, NULL, "device_key",
...
void test_wolk_connector_wolk_init_ffs(void)
{
    ...
    int receive_buffer(unsigned char* buffer, unsigned int max_bytes)
    {
        return 1;
    }
    ...
    TEST_ASSERT_EQUAL_INT(W_FALSE,
                          wolk_init(&wolk, send_buffer, receive_buffer, actuation_handler, actuator_status_provider,
                                    configuration_handler, configuration_provider, "device_key", "device_password",
                                    PROTOCOL_WOLKABOUT, actuator_references, num_actuator_references));
...
void test_wolk_connector_wolk_connect(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(W_FALSE,
                          wolk_init_file_management(
                              ...
                              file_management_get_file_list, file_management_remove_file, file_management_purge_files));
    TEST_ASSERT_EQUAL_INT(
        W_FALSE,
        wolk_init_firmware_update(&wolk, firmware_update_start_installation, firmware_update_is_installation_completed,
...
void test_wolk_connector_wolk_add_string_sensor_reading(void)
{
    ...
    wolk_init(&wolk, NULL, NULL, NULL, ACTUATOR_STATE_READY, NULL, NULL, "device_key", "device_password",
              PROTOCOL_WOLKABOUT, NULL, 0);
...
void test_wolkconnector_wolk_add_multi_value_string_sensor_reading(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(
        W_FALSE, wolk_add_multi_value_string_sensor_reading(&wolk, reference, value, READING_DIMENSIONS, utc_time));
    TEST_ASSERT_TRUE(persistence_pop(&wolk.persistence, &outbound_message));
...
void test_wolk_connector_wolk_add_multi_value_numeric_sensor_reading(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(
        W_FALSE, wolk_add_multi_value_numeric_sensor_reading(&wolk, reference, value, READING_DIMENSIONS, utc_time));
    TEST_ASSERT_TRUE(persistence_pop(&wolk.persistence, &outbound_message));
...
void test_wolk_connector_wolk_add_multi_value_bool_sensor_reading(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(
        W_FALSE, wolk_add_multi_value_bool_sensor_reading(&wolk, reference, value, READING_DIMENSIONS, utc_time));
    TEST_ASSERT_TRUE(persistence_pop(&wolk.persistence, &outbound_message));
...
void test_wolkconnector_wolk_publish_actuator_status(void)
{
    ...
    wolk_init(&wolk, send_buffer, receive_buffer, actuation_handler, actuator_status_provider, NULL, NULL, "device_key",
              "device_password", PROTOCOL_WOLKABOUT, actuator_references, num_actuator_references);
...
void test_wolkconnector_wolk_publish(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(W_FALSE, wolk_init(&wolk, send_buffer, receive_buffer, NULL, NULL, NULL, NULL, "device_key",
                                             "device_password", PROTOCOL_WOLKABOUT, NULL, 0));
    TEST_ASSERT_EQUAL_INT(
        W_FALSE, wolk_init_in_memory_persistence(&wolk, persistence_storage, sizeof(persistence_storage), false));

    // NOTE: This call fails at RPI OS for some reason. It will be commented, anyway this test will be refactored with
    // new WA Protocol
    //    TEST_ASSERT_EQUAL_INT(W_FALSE, wolk_connect(&wolk));
    //
