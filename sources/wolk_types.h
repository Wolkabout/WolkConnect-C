...
extern const char PARAMETER_CONNECTIVITY_TYPE[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_OUTBOUND_DATA_MODE[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_OUTBOUND_DATA_RETENTION_TIME[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_MAXIMUM_MESSAGE_SIZE[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_FILE_TRANSFER_PLATFORM_ENABLED[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_FILE_TRANSFER_URL_ENABLED[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_FIRMWARE_UPDATE_ENABLED[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_FIRMWARE_UPDATE_CHECK_TIME[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_FIRMWARE_UPDATE_REPOSITORY[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_FIRMWARE_VERSION[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_GATEWAY[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_GATEWAY_PARENT[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_EXTERNAL_ID[PARAMETER_TYPE_SIZE];
extern const char PARAMETER_UNKNOWN[PARAMETER_TYPE_SIZE];
...
typedef enum {
    ...
    FILE_MANAGEMENT_ERROR_UNKNOWN = 0,
