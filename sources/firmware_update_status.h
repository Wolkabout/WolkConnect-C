...
typedef enum {
    ...
    FILE_MANAGEMENT_STATE_INSTALLATION,
    FILE_MANAGEMENT_STATE_COMPLETED,
...
typedef enum {
    ...
    FILE_MANAGEMENT_ERROR_FILE_UPLOAD_DISABLED = 1,
    FILE_MANAGEMENT_ERROR_UNSUPPORTED_FILE_SIZE = 2,
    FILE_MANAGEMENT_ERROR_INSTALLATION_FAILED = 3,
    FILE_MANAGEMENT_ERROR_MALFORMED_URL = 4,
